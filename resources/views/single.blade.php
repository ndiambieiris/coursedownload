                                    ...
                                    <article class="course ">
                                        <div class="service shadow-sm sm:rounded-lg">
                                            ...
                                            <div class="mb-3 text-center">
                                               <a href="{{ asset('storage/' .$note->note) }}" alt="uploads" class="btn btn-primary" style="padding: 0.5rem 4.0rem;">Download</a>
                                            </div> 
                                        </div>           
                                    </article>
                                </div> 
                                    ...
                                    <article class="course ">
                                        <div class="service shadow-sm sm:rounded-lg">
                                            ...
                                            <div class="mb-3 text-center">
                                                ...
                                                <a href="{{ asset('storage/' . $tutorial->tutorial) }}" alt="uploads" class="btn btn-primary" style="padding: 0.5rem 4.0rem;">Download</a>
                                            </div> 
                                        </div>        
                                    </article>
                                </div> 
