<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('note.note')">
                                    {{ __('Notes') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('tutorial.tutorial')">
                                        {{ __('Tutorials') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('note.note')" :active="request()->routeIs('note.note')">
                {{ __('Upload Notes') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('tutorial.tutorial')" :active="request()->routeIs('tutorial.tutorial')">
                {{ __('Upload Tutorials') }}
            </x-responsive-nav-link>
        </div>
